...
| Tools | Route `escalate_to_human` to the conversation's channel via a new `channel` parameter, and refuse channels whose `send` cannot deliver instead of reporting a delivery that never happened |
